          ...
          <div>
            <div className="prose dark:prose-invert">
              ...
              <p className="text-lg text-muted-foreground">
                지난 3년간 호텔 예약 시스템부터 B2B 도소매 화훼 플랫폼에 이르기까지, 다양한 비즈니스 도메인의 기반을 다지고 시스템을 고도화해 왔습니다. React를 활용한 프론트엔드 최적화부터 Node.js, NestJS 기반의 견고한 백엔드 설계까지 <span className="text-primary">전체 시스템의 흐름을 꿰뚫어 보는 시야</span>를 갖추고 있습니다. <br/><br/>
