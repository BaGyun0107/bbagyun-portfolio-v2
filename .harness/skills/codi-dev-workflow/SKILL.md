...
| `e2e` | End-to-end tests (user-facing flows) | `mise run e2e:changed` |
| `validate` | Ordered gate: typecheck→test→e2e | `mise run validate` |

### Reference Guide

| Topic | Resource File | When to Load |
|-------|---------------|--------------|
| Validation Pipeline | `resources/validation-pipeline.md` | Git hooks, CI/CD, change-based testing, e2e tasks |
