...
Reset/drop tasks are destructive even in local development. Keep them out of
default verification flows, require explicit user approval before execution,
and document the target database plus restore or rebuild plan.
