...
> **Note**: This file documents the default (Serena/MCP) memory protocol. Vendor-specific execution protocols are injected automatically by `codi agent:spawn` from `execution-protocols/{vendor}.md`.
