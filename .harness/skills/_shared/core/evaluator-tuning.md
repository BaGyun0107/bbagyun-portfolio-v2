...
require human review via `codi retro`.
...
[1] Trigger: EA >= 30 on rolling 3-session window
    ↓
[2] `codi retro` aggregates EA events and generates tuning report
    ↓
...
| `codi retro` | Aggregation + tuning report generation (semi-automated) |
