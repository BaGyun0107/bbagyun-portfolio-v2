...
- Surface merge risk to the user when OSV, npm audit, or security severity
  determines it, and record the decision before merging.
- Flag updates that change source, framework behavior, auth, DB, payment, or
  release-critical tooling for explicit user review before merge.
