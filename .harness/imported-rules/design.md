...
If a project design system exists, it is authoritative for UI work:

- token source of truth: `apps/front/src/styles/tokens.css`
- design principles: `docs/design-system.md`

Read those files on demand before UI implementation or review. Do not preload
project design-system contents into always-on context such as `AGENTS.md`,
`CLAUDE.md`, or always-applied rules. If the project files are absent, use this
document as the shared default.
