...
import { StudyService } from "@/lib/api/services/study.service";
...
export default async function InsightDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const relatedFeature = insight.featureSlug ? await FeatureService.getFeatureBySlug(insight.featureSlug) : null;
  const relatedStudy = insight.studySlug ? await StudyService.getStudyBySlug(insight.studySlug) : null;
