...
> Next.js와 NestJS 간 도메인 분리 환경의 아키텍처 구성에 대해서는 인사이트 **[\[Next.js x NestJS\] 프론트엔드와 백엔드의 도메인 분리, 깨부순 아키텍처 오해들](/insights/nextjs-nestjs-domain-separation-and-bff)**에서 다루고 있습니다.
